...
class Yolo(object):
    ...
    def non_max_suppression(self, filtered_boxes, box_classes, box_scores):
        """ non max suppression.
            Args:
                filtered_boxes: (numpy.ndarray) containing all of
                                the filtered bounding boxes.
                box_classes: (numpy.ndarray) containing the class number for
                             the class that filtered_boxes predicts.
                box_scores: (numpy.ndarray) containing the box scores for
    ...
    def load_images(folder_path):
        """ load images.
            Args:
                folder_path: (str) the path to the folder holding
